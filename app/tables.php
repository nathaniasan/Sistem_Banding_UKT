...
if ($result1->num_rows > 0) {
    ...
    while ($row = $result1->fetch_assoc()) {
        $jurusanOptions[$row['id_jurusan']] = $row['nama_jurusan'];
    }
} else {
...
<body id="page-top">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive pl-3 pr-3">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php while ($result = mysqli_fetch_assoc($koneksi)) { ?>
                                            <tr>
                                                <td>
                                                    <?php echo $no++ . "."; ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-warning btn-sm print-row"
                                                        type="button">
    ...
    <script type="text/javascript">
        var printButtons = document.querySelectorAll('.print-row');
        ...
        function printRow(row) {
            ...
            var printContent = '<html><head><title>Print Page</title>';
            // Memasukkan Bootstrap CSS ke dalam jendela cetak
            printContent += '<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">';
            ...
            for (var i = 0; i < row.cells.length; i++) {
                printContent += '<td>' + row.cells[i].innerHTML + '</td>';
            }
